...
import { n as $$Header } from "./Footer_BCFP2GBT.mjs";
import { n as headerData, t as $$PageLayout } from "./PageLayout_9VhlMFWZ.mjs";
import { t as $$Steps2 } from "./Steps2_Ck7v91Yt.mjs";
import { t as $$Hero2 } from "./Hero2_Coe1wGTV.mjs";
import { t as $$Content } from "./Content_D0WaJu5q.mjs";
import { t as $$FAQs } from "./FAQs_B03MjyKw.mjs";
import { t as $$BlogLatestPosts } from "./BlogLatestPosts_DN9UAGKo.mjs";
import { t as $$Features } from "./Features_D5QlAq_V.mjs";
import { t as $$Pricing } from "./Pricing_CriPZjqa.mjs";
import { t as __exportAll } from "./startup_Be6THNbx.mjs";
//#region src/pages/homes/saas.astro
var saas_exports = /* @__PURE__ */ __exportAll({
	default: () => $$Saas,
	file: () => $$file,
	url: () => $$url
});
var $$Saas = createComponent(($$result, $$props, $$slots) => {
	return renderTemplate`${renderComponent($$result, "Layout", $$PageLayout, { "metadata": { title: "SaaS Landing Page" } }, {
		"default": ($$result) => renderTemplate`${renderComponent($$result, "Hero2", $$Hero2, {
			...
			"title": ($$result) => renderTemplate`${renderComponent($$result, "Fragment", Fragment, { "slot": "title" }, { "default": ($$result) => renderTemplate`Simplify web design with Astrowind: ${maybeRenderHead($$result)}<br> your ultimate <span class="text-accent dark:text-white">SaaS</span> companion<br>` })}`,
			"subtitle": ($$result) => renderTemplate`${renderComponent($$result, "Fragment", Fragment, { "slot": "subtitle" }, { "default": ($$result) => renderTemplate`<span class="hidden sm:inline">Elevate your website creation process with <span class="font-semibold">AstroWind</span>'s SaaS solutions.</span>Seamlessly blend the power of Astro v6 and Tailwind CSS v4 to craft websites that resonate with your brand and audience.` })}`
			...
			"items": [
				...
				},
				{
					...
					description: `Using Astro v6 ensures fast loading and seamless rendering, enhancing browsing. The code follows best practices, improving user experience, SEO, and reducing bounce rates.`,
					icon: "tabler:rocket"
				},
				{
			...
			"items": [{
				title: "Description:",
				description: "Are you a startup with big dreams? AstroWind propels your success. Our template forges a seamless online presence, attracting investors and customers from day one. Astro v6 and Tailwind CSS v4 ensure striking, responsive sites, leaving lasting impressions. Countless startups leverage AstroWind to kickstart their journey and resonate with audiences."
			}, {
				title: "Benefits:",
			...
			"content": ($$result) => renderTemplate`${renderComponent($$result, "Fragment", Fragment, { "slot": "content" }, { "default": ($$result) => renderTemplate`<h3 class="text-2xl font-bold tracking-tight dark:text-white sm:text-3xl mb-2">Startup success stories: <br><span class="text-2xl">Launching with AstroWind</span></h3>` })}`,
			"bg": ($$result) => renderTemplate`${renderComponent($$result, "Fragment", Fragment, { "slot": "bg" }, { "default": ($$result) => renderTemplate`<div class="absolute inset-0 bg-blue-50 dark:bg-transparent"></div>` })}`
		})}${renderComponent($$result, "Content", $$Content, {
			"isAfterContent": true,
			"items": [{
				title: "Description:",
				description: `For SaaS businesses, user experience is key. AstroWind enhances showcasing SaaS solutions intuitively. The template's Astro v6 and Tailwind CSS v4 integration guarantees user-friendly experience, mirroring your software's efficiency. Customize pages to communicate SaaS value and solutions for your audience.`
			}, {
				title: "Benefits:",
			...
			"content": ($$result) => renderTemplate`${renderComponent($$result, "Fragment", Fragment, { "slot": "content" }, { "default": ($$result) => renderTemplate`<h3 class="text-2xl font-bold tracking-tight dark:text-white sm:text-3xl mb-2">SaaS showcase: <br><span class="text-2xl">Streamlining user experience</span></h3>` })}`,
			"bg": ($$result) => renderTemplate`${renderComponent($$result, "Fragment", Fragment, { "slot": "bg" }, { "default": ($$result) => renderTemplate`<div class="absolute inset-0 bg-blue-50 dark:bg-transparent"></div>` })}`
		})}${renderComponent($$result, "Content", $$Content, {
			"isReversed": true,
			"isAfterContent": true,
			...
			"content": ($$result) => renderTemplate`${renderComponent($$result, "Fragment", Fragment, { "slot": "content" }, { "default": ($$result) => renderTemplate`<h3 class="text-2xl font-bold tracking-tight dark:text-white sm:text-3xl mb-2">Creative portfolios: <br><span class="text-2xl">Highlighting your work</span></h3>` })}`,
			"bg": ($$result) => renderTemplate`${renderComponent($$result, "Fragment", Fragment, { "slot": "bg" }, { "default": ($$result) => renderTemplate`<div class="absolute inset-0 bg-blue-50 dark:bg-transparent"></div>` })}`
		})}${renderComponent($$result, "Content", $$Content, {
			"items": [{
				title: "Description:",
			...
			"content": ($$result) => renderTemplate`${renderComponent($$result, "Fragment", Fragment, { "slot": "content" }, { "default": ($$result) => renderTemplate`<h3 class="text-2xl font-bold tracking-tight dark:text-white sm:text-3xl mb-2">Small business growth: <br><span class="text-2xl">Converting visitors into customers</span></h3>` })}`,
			"bg": ($$result) => renderTemplate`${renderComponent($$result, "Fragment", Fragment, { "slot": "bg" }, { "default": ($$result) => renderTemplate`<div class="absolute inset-0 bg-blue-50 dark:bg-transparent"></div>` })}`
		})}${renderComponent($$result, "Pricing", $$Pricing, {
		...
		}, { "bg": ($$result) => renderTemplate`${renderComponent($$result, "Fragment", Fragment, { "slot": "bg" }, { "default": ($$result) => renderTemplate`<div class="absolute inset-0 bg-blue-50 dark:bg-transparent"></div>` })}` })}${renderComponent($$result, "Steps2", $$Steps2, {
		...
		})}${renderComponent($$result, "BlogLatestPosts", $$BlogLatestPosts, {
			"id": "blog",
...
}, "D:/Dev/CoolerPartsNew/coolerparts/src/pages/homes/saas.astro", void 0);
var $$file = "D:/Dev/CoolerPartsNew/coolerparts/src/pages/homes/saas.astro";
var $$url = "/homes/saas";
//#endregion
//#region \0virtual:astro:page:src/pages/homes/saas@_@astro
var page = () => saas_exports;
//#endregion
export { page };
