...
import { b as createComponent, d as getPermalink } from "./runtime_CQAp8_Zo.mjs";
...
import { t as $$Testimonials } from "./Testimonials_DOCYkoPK.mjs";
...
//#region src/pages/homes/personal.astro
var personal_exports = /* @__PURE__ */ __exportAll({
	default: () => $$Personal,
	file: () => $$file,
	url: () => $$url
});
var $$Personal = createComponent(($$result, $$props, $$slots) => {
	return renderTemplate`${renderComponent($$result, "Layout", $$PageLayout, { "metadata": { title: "Personal Homepage Demo" } }, {
		"default": ($$result) => renderTemplate`${renderComponent($$result, "Hero", $$Hero, {
			"id": "hero",
			"title": "Sarah Johnson",
		...
		}, { "subtitle": ($$result) => renderTemplate`${renderComponent($$result, "Fragment", Fragment, { "slot": "subtitle" }, { "default": ($$result) => renderTemplate`I'm a Graphic Designer passionate about crafting visual stories. ${maybeRenderHead($$result)}<br> With 5 years of experience and a degree from New York University's School of Design. I infuse vitality into brands and designs, transforming concepts into captivating realities.` })}` })}${renderComponent($$result, "Content", $$Content, {
			"id": "about",
			"columns": 3,
			"items": [
				{
			...
			"content": ($$result) => renderTemplate`${renderComponent($$result, "Fragment", Fragment, { "slot": "content" }, { "default": ($$result) => renderTemplate`<h2 class="text-2xl font-bold tracking-tight dark:text-white sm:text-3xl mb-2">About me</h2><p>Welcome to my creative journey. My work is a testament to my commitment to bringing ideas to life, where each pixel becomes a brushstroke in the canvas of imagination.</p><br><p>I find inspiration in the world around me, whether through the pages of a captivating novel, the intricate details of typography, or the vibrant hues of nature during my outdoor escapades.</p><br><p>If you're curious to dive deeper into my work, you can follow me:</p>` })}`,
			...
			"content": ($$result) => renderTemplate`${renderComponent($$result, "Fragment", Fragment, { "slot": "content" }, { "default": ($$result) => renderTemplate`<h3 class="text-2xl font-bold tracking-tight dark:text-white sm:text-3xl mb-2">Project 1: <br><span class="text-2xl">Brand identity for tech innovators</span></h3>` })}`,
			"bg": ($$result) => renderTemplate`${renderComponent($$result, "Fragment", Fragment, { "slot": "bg" }, { "default": ($$result) => renderTemplate`<div class="absolute inset-0 bg-blue-50 dark:bg-transparent"></div>` })}`
		})}${renderComponent($$result, "Content", $$Content, {
			"isReversed": true,
			"isAfterContent": true,
			...
			"content": ($$result) => renderTemplate`${renderComponent($$result, "Fragment", Fragment, { "slot": "content" }, { "default": ($$result) => renderTemplate`<h3 class="text-2xl font-bold tracking-tight dark:text-white sm:text-3xl mb-2">Project 2: <br><span class="text-2xl">Event poster for art & music festival</span></h3>` })}`,
			"bg": ($$result) => renderTemplate`${renderComponent($$result, "Fragment", Fragment, { "slot": "bg" }, { "default": ($$result) => renderTemplate`<div class="absolute inset-0 bg-blue-50 dark:bg-transparent"></div>` })}`
		})}${renderComponent($$result, "Content", $$Content, {
			"isReversed": true,
			"isAfterContent": true,
			...
			"content": ($$result) => renderTemplate`${renderComponent($$result, "Fragment", Fragment, { "slot": "content" }, { "default": ($$result) => renderTemplate`<h3 class="text-2xl font-bold tracking-tight dark:text-white sm:text-3xl mb-2">Project 3: <br><span class="text-2xl">E-commerce website redesign for fashion brand</span></h3>` })}`,
			"bg": ($$result) => renderTemplate`${renderComponent($$result, "Fragment", Fragment, { "slot": "bg" }, { "default": ($$result) => renderTemplate`<div class="absolute inset-0 bg-blue-50 dark:bg-transparent"></div>` })}`
		...
		"header": ($$result) => renderTemplate`${renderComponent($$result, "Fragment", Fragment, { "slot": "header" }, { "default": ($$result) => renderTemplate`${renderComponent($$result, "Header", $$Header, {
			"links": [
				...
				{
					text: "Github",
					href: "https://github.com/arthelokyo"
				}
			],
			"actions": [{
				text: "Hire me",
...
}, "D:/Dev/CoolerPartsNew/coolerparts/src/pages/homes/personal.astro", void 0);
var $$file = "D:/Dev/CoolerPartsNew/coolerparts/src/pages/homes/personal.astro";
var $$url = "/homes/personal";
//#endregion
//#region \0virtual:astro:page:src/pages/homes/personal@_@astro
var page = () => personal_exports;
//#endregion
export { page };
