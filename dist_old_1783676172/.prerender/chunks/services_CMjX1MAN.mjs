...
var $$Services = createComponent(($$result, $$props, $$slots) => {
	return renderTemplate`${renderComponent($$result, "Layout", $$PageLayout, { "metadata": { title: "Services" } }, { "default": ($$result) => renderTemplate`${renderComponent($$result, "Hero", $$Hero, {
		"tagline": "Services",
	...
	}, { "content": ($$result) => renderTemplate`${renderComponent($$result, "Fragment", Fragment, { "slot": "content" }, { "default": ($$result) => renderTemplate`${maybeRenderHead($$result)}<h3 class="text-2xl font-bold tracking-tight dark:text-white sm:text-3xl mb-2">Main Features</h3>` })}` })}${renderComponent($$result, "Content", $$Content, {
		"isAfterContent": true,
		"items": [
			{
				title: "Time Savings",
	...
	}, { "content": ($$result) => renderTemplate`${renderComponent($$result, "Fragment", Fragment, { "slot": "content" }, { "default": ($$result) => renderTemplate`<h3 class="text-2xl font-bold tracking-tight dark:text-white sm:text-3xl mb-2">Benefits</h3>` })}` })}${renderComponent($$result, "Testimonials", $$Testimonials, {
...
}, "D:/Dev/CoolerPartsNew/coolerparts/src/pages/services.astro", void 0);
var $$file = "D:/Dev/CoolerPartsNew/coolerparts/src/pages/services.astro";
var $$url = "/services";
//#endregion
