//#region src/data/systems.ts
var systemsData = [
	{
		slug: "water-system",
		name: "Water System",
		shortDesc: "Pumps, Valves, Filtration & Distribution",
		description: "Complete water system components including pumps, motors, filtration, valves, distribution manifolds, and piping connections. Core products for water circulation and management in evaporative cooling units.",
		icon: "tabler:droplet",
		color: "blue",
		priority: 1,
		areas: [
	...
	},
	{
		...
		description: "Evaporation system components including cooling pads, frames, water distributors, spray nozzles, and anti-clogging solutions for efficient evaporative cooling.",
		icon: "tabler:wind",
		color: "emerald",
		priority: 2,
		areas: [
	...
	},
	{
		...
		description: "Air system components including fans, blowers, guards, mounting brackets, and centrifugal fan parts for air movement and ventilation.",
	...
	},
	{
		...
		description: "Electrical and control components including replacement motors, capacitors, speed controllers, control boards, contactors, sensors, and wiring.",
		icon: "tabler:bolt",
		color: "amber",
		priority: 4,
		areas: [
	...
	},
	{
		...
		description: "Structural and mounting components including cabinet panels, seals, gaskets, mounting brackets, caster wheels, and fasteners for assembly and installation.",
		icon: "tabler:tools",
		color: "slate",
		priority: 5,
		areas: [
	...
	},
	{
		...
		description: "Maintenance and consumable items including replacement filter elements, cleaning kit parts, and common wear parts for ongoing cooler upkeep.",
		icon: "tabler:reload",
		color: "stone",
		priority: 6,
		areas: [
	...
	},
	{
		...
		description: "Compatibility and cross-reference resources to help identify the correct replacement parts by interface type, dimensions, electrical parameters, or part number cross-reference.",
...
systemsData.filter((s) => s.priority <= 4);
//#endregion
export { systemsData as t };
