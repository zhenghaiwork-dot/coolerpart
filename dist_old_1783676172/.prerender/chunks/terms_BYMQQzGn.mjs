import { O as unescapeHTML, m as renderTemplate, o as renderComponent } from "./server_DvF4bWil.mjs";
import { b as createComponent } from "./runtime_CQAp8_Zo.mjs";
import { t as __exportAll } from "./startup_DSxiSYRv.mjs";
import { t as $$MarkdownLayout } from "./MarkdownLayout_CwKzc1uf.mjs";
//#region src/pages/terms.md
...
function getHeadings() {
	return [
		{
			"depth": 2,
			"slug": "interpretation-and-definitions",
		...
		{
			"depth": 2,
			"slug": "as-is-and-as-available-disclaimer",
		...
		{
			"depth": 2,
			"slug": "for-european-union-eu-users",
			"text": "For European Union (EU) Users"
		},
		{
			"depth": 2,
			"slug": "united-states-legal-compliance",
			"text": "United States Legal Compliance"
		},
		{
			"depth": 2,
			"slug": "severability-and-waiver",
		...
		{
			"depth": 2,
			"slug": "changes-to-these-terms-and-conditions",
...
//#endregion
//#region \0virtual:astro:page:src/pages/terms@_@md
