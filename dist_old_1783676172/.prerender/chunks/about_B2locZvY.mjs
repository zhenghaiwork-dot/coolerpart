...
import { t as $$Features2 } from "./Features2_Dk-d6GD1.mjs";
...
var $$About = createComponent(($$result, $$props, $$slots) => {
	return renderTemplate`${renderComponent($$result, "Layout", $$PageLayout, { "metadata": { title: "About us" } }, { "default": ($$result) => renderTemplate`${renderComponent($$result, "Hero", $$Hero, {
		"tagline": "About us",
		"image": {
		...
		"title": ($$result) => renderTemplate`${renderComponent($$result, "Fragment", Fragment, { "slot": "title" }, { "default": ($$result) => renderTemplate`Elevate your online presence with our ${maybeRenderHead($$result)}<br><span class="text-accent dark:text-white"> Beautiful Website Templates</span>` })}`,
		"subtitle": ($$result) => renderTemplate`${renderComponent($$result, "Fragment", Fragment, { "slot": "subtitle" }, { "default": ($$result) => renderTemplate`Donec efficitur, ipsum quis congue luctus, mauris magna convallis mauris, eu auctor nisi lectus non augue. Donec quis lorem non massa vulputate efficitur ac at turpis. Sed tincidunt ex a nunc convallis, et lobortis nisi tempus. Suspendisse vitae nisi eget tortor luctus maximus sed non lectus.` })}`
	})}${renderComponent($$result, "Stats", $$Stats, {
	...
	})}${renderComponent($$result, "Steps2", $$Steps2, {
		"title": "Our values",
...
}, "D:/Dev/CoolerPartsNew/coolerparts/src/pages/about.astro", void 0);
var $$file = "D:/Dev/CoolerPartsNew/coolerparts/src/pages/about.astro";
var $$url = "/about";
//#endregion
